package com.gjb.admin.base.auth.exception;

import com.gjb.model.exception.AbstractBaseExceptionEnum;
import lombok.Data;

import static com.gjb.admin.base.auth.exception.enums.AuthExceptionEnum.NO_PERMISSION;

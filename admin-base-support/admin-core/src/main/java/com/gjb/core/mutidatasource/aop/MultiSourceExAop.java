package com.gjb.core.mutidatasource.aop;

import com.gjb.core.mutidatasource.DataSourceContextHolder;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.gjb.core.mutidatasource.annotion.DataSource)")
    private void cut() {

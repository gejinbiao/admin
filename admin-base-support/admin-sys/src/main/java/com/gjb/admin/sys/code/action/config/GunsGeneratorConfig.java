...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/guns2?characterEncoding=utf8");
    }
...
*/
        ...
        contextConfig.setEditJsSwitch(true);
        contextConfig.setAddJsSwitch(true);

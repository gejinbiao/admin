...
import com.gjb.core.util.StrKit;
...
public class WebGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void config() {
        ...
        packageConfig.setEntity(genQo.getProjectPackage() + "."+ genQo.getModuleName() +".model");
        ...
        packageConfig.setService(genQo.getProjectPackage() + "."+ genQo.getModuleName() +".service");
        packageConfig.setController(genQo.getProjectPackage()+ "."+ genQo.getModuleName() +".controller");
        ...
        contextConfig.setEditJsSwitch(genQo.getEditJsSwitch());
        contextConfig.setAddJsSwitch(genQo.getAddJsSwitch());

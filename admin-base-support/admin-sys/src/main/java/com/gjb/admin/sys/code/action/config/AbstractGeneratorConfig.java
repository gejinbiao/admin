package com.gjb.admin.sys.code.action.config;


import com.baomidou.mybatisplus.generator.AutoGenerator;
import com.baomidou.mybatisplus.generator.config.*;
import com.baomidou.mybatisplus.generator.config.po.TableInfo;
import com.gjb.admin.sys.code.engine.SimpleTemplateEngine;
import com.gjb.admin.sys.code.engine.base.TemplateEngine;
import com.gjb.admin.sys.code.engine.config.ContextConfig;
import com.gjb.admin.sys.code.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void init() {
        ...
        packageConfig.setServiceImpl(contextConfig.getProPackage() + ".modular." + contextConfig.getModuleName() + ".service");
    ...
    public void doMpGeneration() {
        ...
        List<com.baomidou.mybatisplus.generator.config.po.TableInfo> tableInfoList = autoGenerator.getConfig().getTableInfoList();
    ...
    public void doGunsGeneration() {
        TemplateEngine GunsTemplateEngine = new SimpleTemplateEngine();

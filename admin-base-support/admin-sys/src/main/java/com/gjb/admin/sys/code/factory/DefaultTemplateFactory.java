package com.gjb.admin.sys.code.factory;
...
public class DefaultTemplateFactory {
    ...
    public static List<Map<String,Object>> getDefaultTemplates(){
        ...
        templates.add(create("editJsSwitch","editJs-修改页js模板"));
        templates.add(create("addJsSwitch","addJs-新增页js模板"));
